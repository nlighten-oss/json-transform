...
export const DateFunctionArgBasedSchemas: Record<string, FunctionDescriptor> = parseSchemas({
  ...
  DIFF: {
    ...
    arguments: [
      ...
      {
        name: "units",
        description: "(DIFF) Units to use (ChronoUnit)",
        type: "enum",
...
export const embeddedFunctions: Record<EmbeddedTransformerFunction, FunctionDescriptor> =
  parseSchemas<EmbeddedTransformerFunction>({
    and: {
    ...
    date: {
      ...
      arguments: [
        ...
        {
          name: "units",
          description: "(ADD/SUB/DIFF) Units to use (ChronoUnit)",
          type: "enum",
          enum: ["NANOS", "MICROS", "MILLIS", "SECONDS", "MINUTES", "HOURS", "HALF_DAYS", "DAYS", "MONTHS", "YEARS"],
          position: 1,
          required: true,
    ...
    not: {
      description:
        "Returns the opposite of the argument\u0027s boolean value (this returns the opposite of `$$boolean`)",
      inputSchema: { type: "object" },
      outputSchema: { type: "boolean" },
      arguments: [
        {
    ...
    numberformat: {
      ...
      arguments: [
        ...
        },
        {
          name: "pattern",
          description:
            "(DECIMAL) See [tutorial](https://docs.oracle.com/javase/tutorial/i18n/format/decimalFormat.html)",
          type: "string",
          position: 2,
          default: "#0.00",
        },
