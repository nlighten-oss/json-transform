 ...
 */
@Aliases("or")
@Documentation("Evaluates to `true` if any of the values provided will evaluate to `true` (using the [Truthy logic])")
@InputType(ArgType.Array)
@OutputType(ArgType.Boolean)
public class TransformerFunctionOr<JE, JA extends Iterable<JE>, JO extends JE> extends TransformerFunction<JE, JA, JO> {
    public TransformerFunctionOr(JsonAdapter<JE, JA, JO> adapter) {
        super(adapter);
    }
    @Override
